...
public class Main extends JFrame{
	private JLabel headerLabel, messageLabel1, messageLabel2, messageLabel3;
	...
	public Main() {
		...
		headerLabel = new JLabel("NOTE: You can also input DC, as it is part of the USA.");
		headerLabel.setSize(300, 30);
		headerLabel.setLocation(13, 5);
		add(headerLabel);
		...
		messageLabel3 = new JLabel("© 2021 Ruben Christopher Arevalo.");
		messageLabel3.setSize(200, 30);
		messageLabel3.setLocation(60, 220);
		add(messageLabel3);
		
		button1 = new JButton("Calculate!");
		button1.setSize(100, 30);
		button1.setLocation(45, 165);
		button1.addActionListener(new Button1Clicked());
		add(button1);
		
		button2 = new JButton("Exit");
		button2.setSize(100, 30);
		button2.setLocation(173, 165);
	...
	private class Button1Clicked implements ActionListener{
		public void actionPerformed(ActionEvent e)
		{
			if (!textField1.getText().equals("") && !textField2.getText().equals("")){
				...
				{
					JOptionPane.showMessageDialog(null, "Calculating...", "Sales Tax Calculator", JOptionPane.INFORMATION_MESSAGE);
					JOptionPane.showMessageDialog(null, "Calculation successful!", "Sales Tax Calculator", JOptionPane.INFORMATION_MESSAGE);
	...
	private class Button2Clicked implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			JOptionPane.showMessageDialog(null, "Exiting system...", "Sales Tax Calculator", JOptionPane.CLOSED_OPTION);
			System.exit(ABORT);
		}
